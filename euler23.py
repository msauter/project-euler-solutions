...
# exactly equal to the number. For example, the sum of the proper divisors of 2
...
# written as the sum of two abundant numbers is 24. By mathematical analysis, i
#t can be shown that all integers greater than 28123 can be written as the sum
